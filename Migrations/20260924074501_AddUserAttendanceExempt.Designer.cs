...
namespace AttendanceSystem.Migrations
{
    ...
    [Migration("20260924074501_AddUserAttendanceExempt")]
    partial class AddUserAttendanceExempt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttendanceSystem.Models.Entities.Announcement", b =>
                {
                    ...
                    b.HasIndex("PublisherUserId")
                        .HasDatabaseName("IX_Announcement_PublisherUserId");

                    b.ToTable("Announcement");
                });

            modelBuilder.Entity("AttendanceSystem.Models.Entities.AnnouncementRead", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_AnnouncementRead");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_AnnouncementRead_UserId");

                    b.HasIndex("AnnouncementId", "UserId")
                        .IsUnique();

                    b.ToTable("AnnouncementRead");
                });
            ...
            modelBuilder.Entity("AttendanceSystem.Models.Entities.ApprovalStep", b =>
                {
                    ...
                    b.HasIndex("ApproverUserId", "ApprovalStatus");
            ...
            modelBuilder.Entity("AttendanceSystem.Models.Entities.AttendancePunch", b =>
                {
                    ...
                    b.HasIndex("UserId", "PunchType", "PunchTime")
                        .IsUnique();
            ...
            modelBuilder.Entity("AttendanceSystem.Models.Entities.AttendanceRecord", b =>
                {
                    ...
                    b.Property<string>("MidCheckResults")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                        .HasColumnName("MidCheckResults");
            ...
            modelBuilder.Entity("AttendanceSystem.Models.Entities.FaceVerifyAttempt", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK_FaceVerifyAttempt");

                    b.HasIndex("UserId", "CreatedAt");

                    b.ToTable("FaceVerifyAttempt");
                });
            ...
            modelBuilder.Entity("AttendanceSystem.Models.Entities.ShiftSchedule", b =>
                {
                    ...
                    b.Property<string>("MidCheckWindows")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                        .HasColumnName("MidCheckWindows");
            ...
            modelBuilder.Entity("AttendanceSystem.Models.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("AllowRemotePunch")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("AllowRemotePunch");
                    ...
                    b.Property<string>("FaceReferencePhotoUrl")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                    ...
                    b.Property<bool>("IsAttendanceExempt")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("IsAttendanceExempt");
            ...
            modelBuilder.Entity("AttendanceSystem.Models.Entities.ZKDeviceCommand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("SN", "Confirmed");

                    b.ToTable("ZKDeviceCommand");
                });

            modelBuilder.Entity("AttendanceSystem.Models.Entities.Announcement", b =>
                {
                    b.HasOne("AttendanceSystem.Models.Entities.User", "Publisher")
                        .WithMany()
                        .HasForeignKey("PublisherUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_Announcement_User_PublisherUserId");
            ...
            modelBuilder.Entity("AttendanceSystem.Models.Entities.AnnouncementRead", b =>
                {
                    b.HasOne("AttendanceSystem.Models.Entities.Announcement", "Announcement")
                        .WithMany("Reads")
                        .HasForeignKey("AnnouncementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_AnnouncementRead_Announcement_AnnouncementId");
                    ...
                    b.HasOne("AttendanceSystem.Models.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_AnnouncementRead_User_UserId");
            ...
            modelBuilder.Entity("AttendanceSystem.Models.Entities.FaceVerifyAttempt", b =>
                {
                    b.HasOne("AttendanceSystem.Models.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_FaceVerifyAttempt_User_UserId");
